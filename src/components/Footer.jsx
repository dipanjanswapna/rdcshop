    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <img src="/logo-white.svg" alt="Red Dot Classroom" className="h-8 mb-4" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/privacy" className="text-gray-400 hover:text-white">প্রাইভেসি পলিসি</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Red Dot Classroom. সর্বস্বত্ব সংরক্ষিত।</p>
        </div>
      </div>
    </footer>
  );
